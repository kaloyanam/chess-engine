...
int main() {
    precomputeMasks();
    setPosition("3rkb1r/1p3ppp/n1bp1q1n/1N2p1N1/p1B1P2P/4BQ2/PP3PP1/2RR2K1 w k - 0 16", bitboard, piece_board);
    ...
    while(true) {
        ...
        if(side == engineSide) {
            ...
            unsigned move = negamax(5, -20000, 20000, bitboard, piece_board).first;
